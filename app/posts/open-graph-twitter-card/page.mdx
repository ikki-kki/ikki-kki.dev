...
export const metadata = {
  ...
  description: 'OG 이미지 그게 뭐데',
  alternates: {
    canonical: 'https://ikki-kki.dev/posts/open-graph-twitter-card',
  },
  openGraph: {
    title: '오픈그래프(Open Grape) 태그와 트위터 카드(Twitter Card)',
    description: 'OG 이미지 그게 뭐데',
    url: 'https://ikki-kki.dev/posts/open-graph-twitter-card',
  },
  twitter: {
...
<Image
  src="/images/open-graph-twitter-card/1.png"
  alt=""
  width={600}
  height={380}
/>
...
<Image
  src="/images/open-graph-twitter-card/2.png"
  alt=""
  width={600}
  height={380}
/>
...
<Image
  src="/images/open-graph-twitter-card/3.png"
  alt=""
  width={600}
  height={380}
/>
...
<Image
  src="/images/open-graph-twitter-card/4.png"
  alt=""
  width={600}
  height={380}
/>
...
<Image
  src="/images/open-graph-twitter-card/5.png"
  alt=""
  width={600}
  height={380}
/>
