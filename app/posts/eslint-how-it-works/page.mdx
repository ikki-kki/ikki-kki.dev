...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://ikki-kki-dev.vercel.app/posts/eslint-how-it-works',
  },
  openGraph: {
    title: 'ESLint 동작 방식 이해',
    description: '태초에 AST가 있었는데요,',
    url: 'https://ikki-kki-dev.vercel.app/posts/eslint-how-it-works',
  },
  twitter: {
...
<Image
  src="/images/eslint-how-it-works/1.png"
  alt=""
  width={600}
  height={150}
/>
...
<Image
  src="/images/eslint-how-it-works/2.png"
  alt=""
  width={600}
  height={150}
/>
...
<Image
  src="/images/eslint-how-it-works/3.png"
  alt=""
  width={600}
  height={380}
/>
...
- 그래서 AST가 뭐라고?
  <Image
    src="/images/eslint-how-it-works/4.png"
    alt=""
    width={600}
    height={380}
  />
  AST(Abstract Syntax Tree)는 컴파일러에서 널리 사용되는 자료구조로 소스코드의
  구조를 트리 형태로 표현한 것입니다. AST를 구성하고 있는 노드는 자신이 어떤
  노드인지를 알려주는 노드 타입, 소스 코드에서 노드의 위치, 하위 자식 노드들에
  대한 레퍼런스 등을 가지고 있습니다. AST에 대해 더 자세하게 알고 싶다면 [해당
  문서](https://itchallenger.tistory.com/709)를 참고하시면 좋습니다.
