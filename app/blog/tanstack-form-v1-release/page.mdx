...
export const metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: generateOgImageUrl('TanStack Form v1 출시 기념 둘러보기'),
        alt: '이세계에서 폼 라이브러리로 전생했더니 너무 강했다',
      },
    ],
  },
}

<Image src="/images/tanstack-form-v1-release/1.png" alt="" width={927} height={496} />
...
솔직히 말해서, 보통 폼 개발은 지루하고 반복적인 작업인데, TanStack Form은 이런 인식을 바꿀 잠재력이 있다. 물론 실제 프로젝트에 적용해봐야 진가를 알겠지만, 지금까지 본 것만으로도 꽤 기대된다.
